...
## Top picks (2026 — verified compatibility)

Three smart locks cover ~85% of typical buyer needs, chosen on real-world reliability data and security audit history. Affiliate links to Amazon below; verify deadbolt fit before ordering.

<ProductBox
  name="August Wi-Fi Smart Lock (4th Gen, Retrofit)"
  priceHint="$229 list (often $149–$179 on sale)"
  pros={[
    "Retrofits existing deadbolt — no key changes for housemates",
    "Works with Alexa, Google, HomeKit, and SmartThings",
    "Encrypted BLE + Wi-Fi via included bridge"
  ]}
  cons={[
    "Bulkier interior assembly than slim alternatives",
    "Battery life ~3 months on heavy use"
  ]}
  href="https://www.amazon.com/dp/B07ZWDFFXG"
  region="us"
/>

<ProductBox
  name="Schlage Encode Plus Wi-Fi Deadbolt"
  priceHint="$299 list (often $219–$249 on sale)"
  pros={[
    "ANSI Grade 1 — highest residential security rating",
    "Built-in Wi-Fi (no hub needed), HomeKit + Matter support",
    "Up to 100 user codes for short-term rental hosts"
  ]}
  cons={[
    "Full deadbolt replacement required",
    "Premium price reflects the build quality"
  ]}
  href="https://www.amazon.com/dp/B07RHRTGCT"
  region="us"
/>

<ProductBox
  name="Yale Assure Lock 2 (with Wi-Fi)"
  priceHint="$259 list (often $199–$229 on sale)"
  pros={[
    "Sleek slim profile, touchscreen with auto-lock",
    "Matter-over-Thread ready (future-proof smart home)",
    "Works without Wi-Fi locally (Bluetooth fallback)"
  ]}
  cons={[
    "Some configurations require optional Wi-Fi module",
    "Touchscreen smudges show under light"
  ]}
  href="https://www.amazon.com/dp/B0B7H5N28J"
  region="us"
/>

All three are CR-recommended and within their respective security tier. Choose August for retrofit (keeping existing keys), Schlage for highest security tier, Yale for slim aesthetic with Matter support.
