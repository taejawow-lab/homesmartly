...
## Top picks (2026 — by floor type and budget)

Three robot vacuums cover the realistic buyer spectrum based on Wirecutter measurements and field reliability. Affiliate links to Amazon below.

<ProductBox
  name="iRobot Roomba i3+ EVO (Self-Empty)"
  priceHint="$549 list (often $349–$399 on sale)"
  pros={[
    "Self-empty base — 60+ days hands-off operation",
    "Strong on carpets (highest suction in mid-tier)",
    "Mature obstacle detection software"
  ]}
  cons={[
    "No LiDAR mapping (uses optical floor tracking)",
    "Bin bags are proprietary and recurring cost"
  ]}
  href="https://www.amazon.com/dp/B08SM1WFLG"
  region="us"
/>

<ProductBox
  name="Roborock Q5+ (Self-Empty, LiDAR)"
  priceHint="$429 list (often $279–$329 on sale)"
  pros={[
    "LiDAR navigation — accurate room mapping and selective cleaning",
    "Self-empty dock with bagged or bagless option",
    "Excellent app: no-go zones, scheduled rooms, virtual walls"
  ]}
  cons={[
    "Slightly weaker on thick carpet vs Roomba",
    "Customer service quality varies by region"
  ]}
  href="https://www.amazon.com/dp/B0B36RBJVH"
  region="us"
/>

<ProductBox
  name="Eufy by Anker RoboVac 11S Max (Slim, Budget)"
  priceHint="$199 list (often $129–$149 on sale)"
  pros={[
    "Slim 2.85-inch profile — fits under most furniture",
    "Quiet (~55 dB) — can run while you're home",
    "Reliable basic random navigation, no Wi-Fi setup hassle"
  ]}
  cons={[
    "No mapping (random pattern only)",
    "No self-empty — manual bin emptying every 2–3 runs"
  ]}
  href="https://www.amazon.com/dp/B0871QTL8H"
  region="us"
/>

Mostly carpet + want zero hands-on: Roomba i3+ EVO. Hardwood + want smart mapping for selective rooms: Roborock Q5+. Tight budget + small apartment: Eufy 11S Max is the best $150 robot vacuum since 2020.
